	      ...
	      <section class="content">
	        ...
	        <div class="row">
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	$sql = "SELECT * FROM votesf WHERE voters_id = '".$voter['id']."'";
				    	$vquery = $conn->query($sql);
				    	if($vquery->num_rows > 0){
				    		?>
				    		<div class="text-center">
					    		<h3>You have already voted for this election.</h3>
					    		<a href="#view" data-toggle="modal" class="btn btn-flat btn-success btn-lg">View Ballot</a>
								<a href="results.php" class="btn btn-flat btn-success btn-lg">View Results</a>
					    	</div>
				    		<?php
				    	}
				    	else{
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
				        			...
				        			$candidate = '';
				        			$sql = "SELECT * FROM positionsf ORDER BY priority ASC";
									$query = $conn->query($sql);
									while($row = $query->fetch_assoc()){
										$sql = "SELECT * FROM candidatesf WHERE position_id='".$row['id']."'";
											...
											<div class="row">
												<div class="col-xs-12">
													<div class="box box-solid" id="'.$row['id'].'">
														...
														<div class="box-header with-border">
														    <h3 class="box-title"><b>Start Date: </b></h3><h3 class="box-title">'.$row['start_date'].'</h3>
															&nbsp
															<h3 class="box-title"><b> End Date: </b></h3><h3 class="box-title">'.$row['end_date'].'</h3>
														</div>
														<div class="box-body">
															<p>'.$instruct.'
