      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-purple">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM votesf GROUP BY voters_id";
                $query = $conn->query($sql);
            ...
            <div class='col-sm-6'>
              <div class='box box-solid'>
                <div class='box-header with-border'>
				 ...
				 <div class='box-header with-border'>
				<h4 class='box-title'><b>Ends on:</b></h4>
				<h4 class='box-title'>".$row['end_date']."</h4>
				</div>
                <div class='box-body'>
                  <div class='chart'>
...
<?php
  ...
  while($row = $query->fetch_assoc()){
    ...
    while($crow = $cquery->fetch_assoc()){
      ...
      $sql = "SELECT * FROM votesf WHERE candidate_id = '".$crow['id']."'";
